...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "Tu to aachi dost hai n meri maaf kr do n?";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
    ...
    text.innerHTML = "Your hand must have slipped right baby?🥹";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "Knew it meri rasmalai, Ye lo puuchi😘";
  yes.innerHTML = '<a href="opt1.html">Message from me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
